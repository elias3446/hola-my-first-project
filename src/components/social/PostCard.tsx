...
export const PostCard = ({ post, onToggleLike, onCommentCountChange, onShareCountChange, onView, onHashtagClick, onDelete, onUpdate, onToggleSave, onMuteUser, onUnmuteUser, isUserMuted, onDetailModalOpen, onRepost }: PostCardProps) => {
  ...
  return (
    ...
    <ShareDialog
      ...
      postId={post.repost_of || post.id} // Share the original post if this is a repost
