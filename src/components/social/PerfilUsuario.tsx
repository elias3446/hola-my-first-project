...
const PerfilUsuario = () => {
  ...
  // Trending posts hook - only for own profile
  const { trendingPosts: userTrendingPosts, loading: trendingLoading } = useTrendingPosts(50, true);
        ...
        <Tabs defaultValue="posts" className="w-full">
          ...
          <TabsContent value="info" className="mt-6">
            <Card>
              ...
              <Link 
                to={isOwnProfile ? "/seguidores" : `/seguidores/${profile.username}`}
